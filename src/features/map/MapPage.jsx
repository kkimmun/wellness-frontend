  ...
  return (
    <MapContainer>
      ...
      <SearchPanel
        ...
        isVisible={
          !isPlanMode && !isDetailOpen && !hasRouteSession && !isCourseMapView
        }
      ...
      <RoutePanel
        ...
        isOpen={isRouteOpen && !isCourseMapView && !isPlanMode}
      ...
      {!isPlanMode && !isCourseMapView && hasRouteSession && (
        <RouteReopenButton
          type="button"
          $isOpen={isRouteOpen}
      ...
      {!isPlanMode && !isCourseMapView && !loading && !error && (
